...
public class HardModeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                        ...
                        public void onFinish() {
                            if (deck1.getId() == deck2.getId()) {
                                ...
                                if (process == arrayList.size() / 2) {
                                    Toast.makeText(HardModeActivity.this, "Chúc mừng bạn đã hoàn thành trò chơi !!!", Toast.LENGTH_SHORT).show();
                                }
                            } else {
                                click = 0;
                                deck1.setStatus(0);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder1 = new AlertDialog.Builder(HardModeActivity.this);
    ...
    private void laydulieu() {
        ...
        Cursor cursor = database.rawQuery("SELECT * FROM trochoi2", null);
        arrayList.clear();
    ...
    private void anhxa() {
        ...
        rv.addItemDecoration(new DividerItemDecoration(HardModeActivity.this,
