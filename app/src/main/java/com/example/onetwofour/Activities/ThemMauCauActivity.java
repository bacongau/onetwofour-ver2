...
public class ThemMauCauActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_them_mau_cau);
        ...
        adapter.setOnItemClickListener(new NguPhapAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                Intent intent = new Intent(ThemMauCauActivity.this,ThemMauCau2Activity.class);
                intent.putExtra("topic11",arrayList.get(position).getTopicName());
    ...
    private void anhxa() {
        ...
        rv = findViewById(R.id.rv_dev_dschude_themmaucau);
        arrayList = new ArrayList<>();
        adapter = new NguPhapAdapter(arrayList);

        rv.setHasFixedSize(true);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(ThemMauCauActivity.this);
        linearLayoutManager.setOrientation(RecyclerView.VERTICAL);
        rv.setLayoutManager(linearLayoutManager); // set kieu sap xep cac item trong recyclerview

        rv.setAdapter(adapter);
        rv.addItemDecoration(new DividerItemDecoration(ThemMauCauActivity.this,
