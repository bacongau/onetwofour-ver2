...
public class MediumModeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                        ...
                        public void onFinish() {
                            if (deck1.getId() == deck2.getId()) {
                                ...
                                if (process == arrayList.size() / 2) {
                                    Toast.makeText(MediumModeActivity.this, "Chúc mừng bạn đã hoàn thành trò chơi !!!", Toast.LENGTH_SHORT).show();
                                }
                            } else {
                                click = 0;
                                deck1.setStatus(0);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder1 = new AlertDialog.Builder(MediumModeActivity.this);
    ...
    private void laydulieu() {
        database = DataBase.initDatabase(MediumModeActivity.this, DATABASE_NAME);
        Cursor cursor = database.rawQuery("SELECT * FROM trochoi2 WHERE id < 11", null);
        arrayList.clear();
    ...
    private void anhxa() {
        ...
        rv.addItemDecoration(new DividerItemDecoration(MediumModeActivity.this,
